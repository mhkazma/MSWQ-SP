...
logdet_4_CS1 = load_sensor_data('Copt_M_CS2_MSX1.mat', 0)  # Row 0 for 4 sensors
logdet_6_CS1 = load_sensor_data('Copt_M_CS2_MSX1.mat', 1)  # Row 1 for 6 sensors

# Load data for Trace with 4 and 6 sensors for CS1
trace_4_CS1 = load_sensor_data('Copt_M_trace_CS2_MSX1.mat', 0)  # Row 0 for 4 sensors
trace_6_CS1 = load_sensor_data('Copt_M_trace_CS2_MSX1.mat', 1)  # Row 1 for 6 sensors
...
# Plot LogDet heatmaps it was 5.5 before salma 
...
plt.savefig('LogDet_CS2.pdf', dpi=600, format='pdf', bbox_inches='tight')
plt.show()
...
ax1.set_xticklabels(time_labels_two_hour, rotation=0, ha="center")
ax1.set_ylabel("Sensor Node")
ax1.set_title(r"(g) Trace with 4 Sensors")
ax1.title.set_position((0.1, 1.0))
...
plt.savefig('Trace_CS2.pdf', dpi=600, format='pdf', bbox_inches='tight')
plt.show()