...
heatmap1 = sns.heatmap(logdet_12_CS1, annot=False, ax=ax1, cmap=palette, linewidths=1, linecolor='grey', square=True,
                       cbar=False)
...
ax1.set_title(r"(a) Logdet with 12 Sensors")
ax1.title.set_position((0.1, 1.0))

# Heatmap for the second data with square cells, no annotations and grey borders
heatmap2 = sns.heatmap(logdet_18_CS1, annot=False, ax=ax2, cmap=palette, linewidths=1, linecolor='grey', square=True,
                       cbar=False)
...
ax2.set_title(r"(b) Logdet with 18 Sensors")
ax2.title.set_position((0.1, 1.0))

# Save the figure as a PDF
plt.savefig('OSP_logdet_Net2.pdf', dpi=600, format='pdf', bbox_inches='tight')
plt.show()