...
logdet_4_CS1 = load_sensor_data('Copt_M_CS1_MSX1.mat', 0)  # Row 0 for 4 sensors
logdet_6_CS1 = load_sensor_data('Copt_M_CS1_MSX1.mat', 1)  # Row 1 for 6 sensors

# Load data for Trace with 4 and 6 sensors for CS1
trace_4_CS1 = load_sensor_data('Copt_M_trace_CS1_MSX1.mat', 0)  # Row 0 for 4 sensors
trace_6_CS1 = load_sensor_data('Copt_M_trace_CS1_MSX1.mat', 1)  # Row 1 for 6 sensors
...
ax1.set_title(r"(a) Logdet with 4 Sensors")
...
ax2.set_title(r"(b) Logdet with 6 Sensors")
ax2.title.set_position((0.1, 1.0))

plt.savefig('LogDet_CS1.pdf', dpi=600, format='pdf', bbox_inches='tight')
plt.show()
...
ax2.set_ylabel("Sensor Node")
ax2.set_xlabel("Time (hr)")
ax2.set_title(r"(d) Trace with 6 Sensors")
ax2.title.set_position((0.1, 1.0))

plt.savefig('Trace_CS1.pdf', dpi=600, format='pdf', bbox_inches='tight')
plt.show()