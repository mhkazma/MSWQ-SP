...
logdet_4_CS1 = load_sensor_data('Copt_M_CS3_MSX1.mat', 0)  # Row 0 for 4 sensors
logdet_6_CS1 = load_sensor_data('Copt_M_CS3_MSX1.mat', 1)  # Row 1 for 6 sensors

# Load data for Trace with 4 and 6 sensors for CS1
trace_4_CS1 = load_sensor_data('Copt_M_trace_CS3_MSX1.mat', 0)  # Row 0 for 4 sensors
trace_6_CS1 = load_sensor_data('Copt_M_trace_CS3_MSX1.mat', 1)  # Row 1 for 6 sensors
...
plt.savefig('LogDet_CS3.pdf', dpi=600, format='pdf', bbox_inches='tight')
plt.show()
...
plt.savefig('Trace_CS3.pdf', dpi=600, format='pdf', bbox_inches='tight')
plt.show()