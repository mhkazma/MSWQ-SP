...
% Plot grouped bars
b = bar(JunctionIndex(:,2:35), [BaseDemand_CS1(:,2:35); BaseDemand_CS2(:,2:35); BaseDemand_CS3(:,2:35)]', ...
    'grouped', 'BarWidth', 1);
...
print('Base-Demand-NET2','-depsc2','-r600')
...
stairs(time, PatternVal_CS1(1:24), 'LineWidth', 3,'Color', [0.2, 0.6, 0.8]);  % PatternVal CS1 (light blue)
hold on;
stairs(time, PatternVal_CS2(1:24), 'LineWidth', 3,'LineStyle','-.','Color', [0.8, 0.4, 0.4]);  % PatternVal CS2 (light red)
stairs(time, PatternVal_CS3(1:24), 'LineWidth', 3,'LineStyle',':','Color', [0.4, 0.7, 0.4]);  % PatternVal CS3 (light green)
hold off;
...
print('PatternVal-NET2', '-depsc2', '-r600');